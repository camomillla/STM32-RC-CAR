...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, ENCODER_LF1_Pin|ENCODER_LF2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(ENCODER_LB1_GPIO_Port, ENCODER_LB1_Pin);

    HAL_GPIO_DeInit(ENCODER_LB2_GPIO_Port, ENCODER_LB2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCODER_RF1_Pin|ENCODER_RF2_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, ENCODER_RB1_Pin|ENCODER_RB2_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM9_MspDeInit 0 */
    ...
    PE5     ------> TIM9_CH1
    */
    HAL_GPIO_DeInit(DETECTOR_ECHO_GPIO_Port, DETECTOR_ECHO_Pin);
